        ...
        public class myJob_00001_DetectionAlgorithmJob : IJob
        {
            ...
            public async Task Execute(IJobExecutionContext context)
            {
                try
                {
                    ...
                    JObject dODAlgorithmResultJson = SmICSCoreLib.AQL.DetectionAlgorithmInterface.DetectionAlgorithmInterface.RunDetectionAlgorithmCovid19Extension(cur_path_of_r_script,
