...
namespace SmICSCoreLib.AQL
{
    public sealed class AQLCatalog
    {
        ...
        public static AQLQuery InfectionsStatusDevelopmentCurve(TimespanParameter timespanParameter)
        {
            //PW20210215__return new AQLQuery($"SELECT o/items[at0001]/value/id as SpecimenIdentifier, o/items[at0015]/value/value as Zeitpunkt, k/items[at0001, 'Nachweis']/value/value as VirologicalTestResult, k/items[at0024, 'Virus']/value/value as DiseaseName FROM EHR e CONTAINS COMPOSITION c CONTAINS OBSERVATION q[openEHR-EHR-OBSERVATION.laboratory_test_result.v1] CONTAINS (CLUSTER o[openEHR-EHR-CLUSTER.specimen.v1] and CLUSTER k[openEHR-EHR-CLUSTER.laboratory_test_analyte.v1]) where c/context/start_time/value>='{ timespanParameter.Starttime.ToString("o") }' and c/context/start_time/value<='{ timespanParameter.Endtime.ToString("o") }'");
            //
            //PW20210215__return new AQLQuery($"SELECT o/items[at0001]/value/id as SpecimenIdentifier, o/items[at0015]/value/value as Zeitpunkt, k/items[at0001, 'Nachweis']/value/value as VirologicalTestResult, k/items[at0024, 'Virus']/value/value as DiseaseName FROM EHR e CONTAINS COMPOSITION c[openEHR-EHR-COMPOSITION.report-result.v1] CONTAINS OBSERVATION q[openEHR-EHR-OBSERVATION.laboratory_test_result.v1] CONTAINS (CLUSTER o[openEHR-EHR-CLUSTER.specimen.v1] and CLUSTER k[openEHR-EHR-CLUSTER.laboratory_test_analyte.v1]) where c/name/value='Virologischer Befund' and o/items[at0015]/value/value>='2020-03-01' and o/items[at0015]/value/value<='2020-08-20'");
            //
            //PW20210217__return new AQLQuery($"SELECT o/items[at0001]/value/id as SpecimenIdentifier, o/items[at0015]/value/value as Zeitpunkt, k/items[at0001, 'Nachweis']/value/value as VirologicalTestResult, k/items[at0024, 'Virus']/value/value as DiseaseName FROM EHR e CONTAINS COMPOSITION c[openEHR-EHR-COMPOSITION.report-result.v1] CONTAINS OBSERVATION q[openEHR-EHR-OBSERVATION.laboratory_test_result.v1] CONTAINS (CLUSTER o[openEHR-EHR-CLUSTER.specimen.v1] and CLUSTER k[openEHR-EHR-CLUSTER.laboratory_test_analyte.v1]) where c/name/value='Virologischer Befund' and o/items[at0015]/value/value>='2019-12-01' and o/items[at0015]/value/value<='2021-02-10'");
            //PW20210510__return new AQLQuery($"SELECT o/items[at0001]/value/id as SpecimenIdentifier, o/items[at0015]/value/value as Zeitpunkt, k/items[at0001, 'Nachweis']/value/value as VirologicalTestResult, k/items[at0024, 'Virus']/value/value as DiseaseName FROM EHR e CONTAINS COMPOSITION c[openEHR-EHR-COMPOSITION.report-result.v1] CONTAINS OBSERVATION q[openEHR-EHR-OBSERVATION.laboratory_test_result.v1] CONTAINS (CLUSTER o[openEHR-EHR-CLUSTER.specimen.v1] and CLUSTER k[openEHR-EHR-CLUSTER.laboratory_test_analyte.v1]) where c/name/value='Virologischer Befund' and o/items[at0015]/value/value>='2010-01-01' and o/items[at0015]/value/value<='2021-02-10'");
            return new AQLQuery("InfectionsStatusDevelopmentCurve", $@"SELECT o/items[at0001]/value/id as SpecimenIdentifier, o/items[at0015]/value/value as Zeitpunkt, k/items[at0001, 'Nachweis']/value/value as VirologicalTestResult, k/items[at0024, 'Virus']/value/value as DiseaseName FROM EHR e CONTAINS COMPOSITION c[openEHR-EHR-COMPOSITION.report-result.v1] CONTAINS OBSERVATION q[openEHR-EHR-OBSERVATION.laboratory_test_result.v1] CONTAINS (CLUSTER o[openEHR-EHR-CLUSTER.specimen.v1] and CLUSTER k[openEHR-EHR-CLUSTER.laboratory_test_analyte.v1]) where c/name/value='Virologischer Befund' and o/items[at0015]/value/value>='2010-01-01' and o/items[at0015]/value/value<='2021-02-10'");
        }

        public static AQLQuery InfectionsStatusDevelopmentCurveMicrobiologicalFinding(TimespanParameter timespanParameter)
        {
            //PW20210510__return new AQLQuery($"SELECT o/items[at0001]/value/id as SpecimenIdentifier, o/items[at0015]/value/value as Zeitpunkt, k/items[at0024, 'Nachweis?']/value/value as VirologicalTestResult, k/items[at0001, 'Erregername']/value/value as DiseaseName FROM EHR e CONTAINS COMPOSITION c CONTAINS OBSERVATION q[openEHR-EHR-OBSERVATION.laboratory_test_result.v1] CONTAINS (CLUSTER o[openEHR-EHR-CLUSTER.specimen.v1] and CLUSTER k[openEHR-EHR-CLUSTER.laboratory_test_analyte.v1]) where c/context/start_time/value>='{ timespanParameter.Starttime.ToString("o") }' and c/context/start_time/value<='{ timespanParameter.Endtime.ToString("o") }'");
            return new AQLQuery("InfectionsStatusDevelopmentCurveMicrobiologicalFinding", $@"SELECT o/items[at0001]/value/id as SpecimenIdentifier, o/items[at0015]/value/value as Zeitpunkt, k/items[at0024, 'Nachweis?']/value/value as VirologicalTestResult, k/items[at0001, 'Erregername']/value/value as DiseaseName FROM EHR e CONTAINS COMPOSITION c CONTAINS OBSERVATION q[openEHR-EHR-OBSERVATION.laboratory_test_result.v1] CONTAINS (CLUSTER o[openEHR-EHR-CLUSTER.specimen.v1] and CLUSTER k[openEHR-EHR-CLUSTER.laboratory_test_analyte.v1]) where c/context/start_time/value>='{ timespanParameter.Starttime.ToString("o") }' and c/context/start_time/value<='{ timespanParameter.Endtime.ToString("o") }'");
        }
    }
}
