...
namespace SmICSDataGenerator.Tests.EmployeeInformationTests
{
    public class EmployeeContactTracingTest
    {
        ...
        public void ProcessorTest(string ehrID, int ResultSetID) 
        {
            ...
            List<ContactTracingModel> expected = GetExpectedContactTracingModels(ResultSetID);
        ...
        private List<ContactTracingModel> GetExpectedContactTracingModels(int ResultSetID)
        {
            string path = "../../../../TestData/EmployeeContactTracinTestResults.json";
            List<ContactTracingModel> result = ExpectedResultJsonReader.ReadResults<ContactTracingModel>(path, ResultSetID, ExpectedType.PATIENT_SYMPTOM);
            return result;
        }
